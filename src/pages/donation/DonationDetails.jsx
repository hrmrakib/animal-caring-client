...
const DonationForm = ({ amount, setAmount, closeModal }) => {
  ...
  return (
    <form onSubmit={handleFormSubmit} className='dark:bg-gray-900'>
      <div className='mb-4'>
        ...
        <input
          ...
          required
          className='w-full px-3 py-2 border rounded dark:text-gray-100 dark:bg-gray-900'
        />
      </div>
      <div className='mb-4 dark:text-gray-100'>
        ...
        <div className='w-full px-3 py-2 border rounded dark:text-gray-100'>
          <CardElement />
        </div>
      </div>
      <button
...
const DonationDetails = () => {
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      {/* pet detail */}
      <div className='p-5 bg-white dark:bg-gray-900 dark:text-gray-100 shadow-md rounded-lg overflow-hidden'>
        <div className='flex gap-5'>
          ...
          <div>
            ...
            <p className='text-gray-700 mb-6 dark:text-gray-100'>
      ...
      <div className='mt-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          {recommendedDonations.map((donation) => (
            <div
              key={donation._id}
              className='bg-white dark:bg-gray-900 dark:text-gray-100 shadow-md rounded-lg overflow-hidden'
            >
              <img
                src={donation?.image}
                alt={donation?.name}
      ...
      <Elements stripe={stripePromise}>
        <Transition show={isModalOpen} as={React.Fragment}>
          ...
          >
            ...
            <div className='bg-white dark:bg-gray-900 dark:text-gray-100 rounded-lg p-6 w-full max-w-lg mx-auto z-10'>
