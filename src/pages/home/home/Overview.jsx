    ...
    >
      <div className='w-full h-full flex flex-col justify-center items-center bg-black bg-opacity-35'>
        <div className='w-[90%] mx-auto flex flex-col justify-center'>
          ...
          <div>
            <h2 className='text-5xl font-bold text-white max-w-[660px] mb-6'>
              Share your love with the pets in need of a home
            </h2>

            <p className='text-gray-200 text-lg max-w-[700px]'>
          ...
          <div className='mt-6 flex items-center gap-16 flex-wrap'>
            <div>
              <h2 className='text-6xl font-bold text-purple-600 mb-2'>97%</h2>
              <p className='text-gray-300 text-lg'>
                SUCCESSFUL <br /> RESCUE
              </p>
            </div>
            <div>
              <h2 className='text-6xl font-bold text-purple-600 mb-2'>325+</h2>
              <p className='text-gray-300 text-lg'>
                DEDICATED <br /> VOLUNTEER
              </p>
            </div>
            <div>
              <h2 className='text-6xl font-bold text-purple-600 mb-2'>$14M+</h2>
              <p className='text-gray-300 text-lg'>
