      ...
      <div className='w-[90%] mx-auto navbar flex justify-between'>
        ...
        <div className='navbar-end flex items-center max-w-[70%]'>
          ...
          <div className='flex items-center gap-5'>
            <div className='mr-2 md:mr-8 form-control'>
              <div className='flex items-center'>
                <div>
                  <label className='swap swap-rotate'>
                    ...
                    <svg
                      className='swap-on fill-current w-10 h-10 text-gray-900 dark:text-white'
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 24 24'
                    >
                    ...
                    <svg
                      className='swap-off fill-current w-10 h-10 text-gray-900 dark:text-white'
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 24 24'
                    >
